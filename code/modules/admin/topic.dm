...
/datum/admins/Topic(href, href_list)
	...
	/*
		...
		if (SSticker.HasRoundStarted())
			if (browser_alert(usr, "The game has already started. Would you like to save this as the default mode effective next round?", "Save mode", "Yes", "Cancel", Timeout = null) == "Yes")
		...
		if (browser_alert(usr, "Would you like to save this as the default mode for the server?", "Save mode", "Yes", "No", Timeout = null) == "Yes")
